describe Wf do
  ...
  it 'executes code in chain block and store it in outflow (guess the name!)' do
    wf.chain(__) { 2 }
  ...
  it 'doesnt execute chain blocks once dammed' do
    expect do
      wf.when_falsy { __ }.dam { 'error' }.chain { raise 'I should not be executed because of damming before me' }
